Function Get-Teams {
    ...
    {
        Write-Warning 'This query/command is currently only supported on the Beta endpoint - please call 'Connect-MSGrap' again with the following setting: -BaseUrl "https://graph.microsoft.com/beta/"'
    } else {
